(function () {
    // ConversationId, customer id and userID is dynamic, coming from the server
    // The profile image is also dynamic
    // Some properties of the css also may be dynamic depending on the customization from the frontend part
    // 
  ...
  const BASE_URL =
    "https://django-andromedia-api-a0c055964407.herokuapp.com/api/v1";
  let socket;
  const ChatWidget = {
    init: function () {
        // Load Axios instance
      ...
      // linkElement.href = 'style.css'; // for local testing
      linkElement.href = "https://beemhuse.github.io/widget-styles/style.css"; // css hosted file 
    ...
    //   chat Icon to open up the chat interface
      const chatIcon = document.createElement("img");
      chatIcon.src =
        "https://res.cloudinary.com/dj3zrsni6/image/upload/v1697742309/chat/chat-icon_lyz27d.png";
    ...
    // Top container which contains the image and other icons
      ...
      topContainer.classList.add("top_container");
       ...
       dummyImg.src =
         "https://res.cloudinary.com/dj3zrsni6/image/upload/v1697808425/chat/icons8-avatar-50_s7v65b.png";
       dummyImg.style.cursor = "pointer";
 
       const call = document.createElement("img");
       call.classList.add("call");
       call.src =
         "https://res.cloudinary.com/dj3zrsni6/image/upload/v1697808425/chat/icons8-call-48_sf2fl0.png";
       call.style.cursor = "pointer";
 
       const menu = document.createElement("img");
       menu.classList.add("menu");
       menu.src =
         "https://res.cloudinary.com/dj3zrsni6/image/upload/v1697742309/chat/menu_vsqkeb.png";
       menu.style.cursor = "pointer";
 

    //   Messages container to send message
    ...
    //   Button to close the chatWidgetContainer
      const closeButton = document.createElement("img");
      closeButton.classList.add("close_button");
      closeButton.src =
        "https://res.cloudinary.com/dj3zrsni6/image/upload/v1698061111/chat/icons8-arrow-down-50_kcenej.png";
      ...
      async function getCountryFromIpinfo(ipAddress) {
        ...
        try {
          ...
          console.log(data);
          console.log(
            `The country for the IPv6 address ${ipAddress} is ${countryName}`
          );
        } catch (error) {
          console.error(
      ...
      onlineImg.src =
        "https://res.cloudinary.com/dj3zrsni6/image/upload/v1697869616/chat/icons8-dot-30_kasujc.png";
    ...
    //   Function to close and open the chatWidget
      function toggleChatWidget() {
        console.log("click");
        chatWidgetContainer.style.display =
        ...
        chatIcon.style.display =
          chatWidgetContainer.style.display === "none" ? "block" : "none";
        chatIcon.src =
          chatWidgetContainer.style.display === "none"
            ? "https://res.cloudinary.com/dj3zrsni6/image/upload/v1697742309/chat/chat-icon_lyz27d.png"
            : null;
    ...
    //   Function to Update the UI
      function updateUI(messages) {
        ...
        {
          messages &&
            messages.reverse().map((messageObj, index) => {
    ...
    //   Check if message exists
      ...
      // To start a conversation Endpoint
      ...
      async function createConversationMessages(
        ...
        try {
          const response = await axios.post(
            `${BASE_URL}/conversations/${conversationId}/messages/create/`,
            conversationData
          );
...
console.log(apiMessages)
      ...
      function getAllConversations() {
        ...
        //   apiMessages = conversationData
        updateUI(conversationData);
          })
          .catch((error) => {
        ...
        if (socket.readyState === WebSocket.OPEN) {
          ...
          if (messageExists()) {
            if (messageInput) {
              ...
              updateUI(messageInput, "sent", true);
              inputElement.value = "";
    ...
    //   Button to send messages
      ...
      sendButton.src =
        "https://res.cloudinary.com/dj3zrsni6/image/upload/v1697742309/chat/send-icon_moe1uo.png";
      ...
      socket.addEventListener("close", (event) => {
        ...
        setTimeout(() => {
          socket = new WebSocket(socketUrl);
          init(); // Reinitialize the chat widget after reconnecting
        }, 5000);
      });
